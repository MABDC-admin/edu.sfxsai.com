...
export class TeacherController {
  ...
  async createScheduleEntry(
    @Req() req: AuthenticatedRequest,
    @Body() body: Parameters<TeacherService['createScheduleEntry']>[1],
  ) {
  ...
  async updateScheduleEntry(
    @Req() req: AuthenticatedRequest,
    @Param('id') id: string,
    @Body() body: Parameters<TeacherService['updateScheduleEntry']>[2],
  ) {
  ...
  async deleteScheduleEntry(@Req() req: AuthenticatedRequest, @Param('id') id: string) {
