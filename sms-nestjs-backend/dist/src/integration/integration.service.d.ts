...
export declare class IntegrationService {
    ...
    private requireAcademicYear;
    private log;
    getStudentFinanceProfile(studentId: string, academicYearId: string, performedById?: string): Promise<{
        student: {
            id: string;
            studentNo: string;
            lrn: string;
    ...
    getFinanceClearance(academicYearId: string, performedById?: string): Promise<{
        studentId: string;
        student: {
            id: string;
            studentNo: string;
    ...
    syncStudentFinanceStatus(studentId: string, academicYearId: string, performedById?: string): Promise<{
        id: string;
        studentNo: string;
        lrn: string;
        firstName: string;
