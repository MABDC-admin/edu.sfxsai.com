...
let CalendarEventsService = class CalendarEventsService {
    ...
    async findAll(ayId) {
        return this.drizzle.db.query.calendarEvent.findMany({
            where: ayId
                ? (0, drizzle_orm_1.or)((0, drizzle_orm_1.eq)(schema.calendarEvent.academicYearId, ayId), (0, drizzle_orm_1.isNull)(schema.calendarEvent.academicYearId))
                : undefined,
    ...
    async findOne(id) {
        return this.drizzle.db.query.calendarEvent.findFirst({
            where: (0, drizzle_orm_1.eq)(schema.calendarEvent.id, id),
        });
    }
    ...
    async remove(id) {
        const [deleted] = await this.drizzle.db.delete(schema.calendarEvent).where((0, drizzle_orm_1.eq)(schema.calendarEvent.id, id)).returning();
        return deleted;
    }
};
