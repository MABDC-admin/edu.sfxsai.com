...
let DocumentRequirementsService = class DocumentRequirementsService {
    drizzle;
    constructor(drizzle) {
    ...
    async findAll(ayId) {
        return this.drizzle.db.query.documentRequirement.findMany({
            where: ayId ? (0, drizzle_orm_1.eq)(schema.documentRequirement.academicYearId, ayId) : undefined,
        });
    }
    async findOne(id) {
        return this.drizzle.db.query.documentRequirement.findFirst({
            where: (0, drizzle_orm_1.eq)(schema.documentRequirement.id, id),
        });
    }
    ...
    async remove(id) {
        const [deleted] = await this.drizzle.db.delete(schema.documentRequirement).where((0, drizzle_orm_1.eq)(schema.documentRequirement.id, id)).returning();
        return deleted;
    }
};
exports.DocumentRequirementsService = DocumentRequirementsService;
exports.DocumentRequirementsService = DocumentRequirementsService = __decorate([
