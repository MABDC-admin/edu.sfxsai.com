...
let AdminTeachersController = class AdminTeachersController {
    adminTeachers;
    constructor(adminTeachers) {
        this.adminTeachers = adminTeachers;
    }
    findAll() {
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], AdminTeachersController.prototype, "resetPassword", null);
exports.AdminTeachersController = AdminTeachersController = __decorate([
    (0, common_1.Controller)('admin/teachers'),
    (0, roles_decorator_1.Roles)('ADMIN'),
    __metadata("design:paramtypes", [admin_teachers_service_1.AdminTeachersService])
