...
import {
  JSON_SCHEMA,
  load
} from "./chunk-5GMJYIP3.js";
import {
  registerLayoutLoaders
} from "./chunk-URZ4NHB5.js";
import "./chunk-SFGFBOSL.js";
import "./chunk-VF3CI3IP.js";
import "./chunk-MMN5CWGT.js";
import "./chunk-76QUJQJG.js";
import "./chunk-WH4BLED4.js";
import "./chunk-OVGL3XHM.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-FCHZCGZB.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
var loader = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./c4Diagram-AAUBKEIU-I3FHBPEQ.js");
...
var loader2 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./flowDiagram-I6XJVG4X-CZKO73ZM.js");
...
var loader4 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./erDiagram-TEJ5UH35-5Q7EOBJC.js");
...
var loader5 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./gitGraphDiagram-PVQCEYII-CDNQXZZD.js");
...
var loader6 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./ganttDiagram-6RSMTGT7-GDDNXLDD.js");
...
var loader7 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./infoDiagram-5YYISTIA-HHCBA35B.js");
...
var loader8 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./pieDiagram-4H26LBE5-PXUCYE45.js");
...
var loader9 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./quadrantDiagram-W4KKPZXB-5WTAUFPK.js");
...
var loader10 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./xychartDiagram-2RQKCTM6-VIV66HDU.js");
...
var loader11 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./requirementDiagram-4Y6WPE33-7ICC4PMO.js");
...
var loader12 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./sequenceDiagram-3UESZ5HK-QJEXXWTL.js");
...
var loader13 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./classDiagram-4FO5ZUOK-3ZBMWYDM.js");
...
var loader14 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./classDiagram-v2-Q7XG4LA2-HP5N2UVU.js");
...
var loader15 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./stateDiagram-AJRCARHV-JUDV62DU.js");
...
var loader16 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./stateDiagram-v2-BHNVJYJU-O4HRV6JP.js");
...
var loader17 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./journeyDiagram-JHISSGLW-QGSV4URF.js");
...
var loader19 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./timeline-definition-PNZ67QCA-47T6V3JH.js");
...
var loader20 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./mindmap-definition-RKZ34NQL-OUM5TBAI.js");
...
var loader21 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./kanban-definition-UN3LZRKU-4BYNK6IS.js");
...
var loader22 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./sankeyDiagram-5OEKKPKP-RE4FHMTD.js");
...
var loader23 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-LMA3HP47-42KYTAC4.js");
...
var loader24 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-2AECGRRQ-325RNJTU.js");
...
var loader25 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./blockDiagram-GPEHLZMM-VGLAFZUI.js");
...
var loader26 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-5GNKFQAL-UA7M6UP4.js");
...
var loader27 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./architectureDiagram-3BPJPVTR-2O6LYHT2.js");
...
var loader28 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-KO2AKTUF-KUHKSEDQ.js");
...
var loader29 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./ishikawaDiagram-YF4QCWOH-P6HH66QS.js");
...
var loader30 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./vennDiagram-CIIHVFJN-2OH2XYUA.js");
...
var loader31 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./diagram-OG6HWLK6-MXSQPLC2.js");
...
var loader32 = __name(() => __async(null, null, function* () {
  const { diagram: diagram2 } = yield import("./wardleyDiagram-YWT4CUSO-3SOQJ5EQ.js");
...
var loadRegisteredDiagrams = __name(() => __async(null, null, function* () {
  ...
  const results = yield Promise.allSettled(
    Object.entries(detectors).map((_0) => __async(null, [_0], function* ([key, { detector: detector33, loader: loader33 }]) {
      if (!loader33) {
        return;
      }
      try {
        ...
        try {
          const { diagram: diagram2, id: id33 } = yield loader33();
  ...
  static fromText(_0) {
    return __async(this, arguments, function* (text, metadata = {}) {
      ...
      try {
        ...
        const { id: id33, diagram: diagram2 } = yield loader33();
...
var render = __name(function(id33, text, svgContainingElement) {
  return __async(this, null, function* () {
    addDiagrams();
...
var runThrowsErrors = __name(function() {
  return __async(this, arguments, function* ({ postRenderCallback, querySelector, nodes } = {
    ...
    for (const element of Array.from(nodesToProcess)) {
      ...
      try {
        const { svg, bindFunctions } = yield render2(id33, txt, element);
