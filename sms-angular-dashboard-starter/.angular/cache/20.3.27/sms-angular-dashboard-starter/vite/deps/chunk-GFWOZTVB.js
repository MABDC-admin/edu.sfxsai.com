...
function isMatchWithInternal(target, source, compare, stack) {
  ...
  switch (typeof source) {
    ...
    case "function":
      if (Object.keys(source).length > 0) return isMatchWithInternal(target, __spreadValues({}, source), compare, stack);
...
//# sourceMappingURL=chunk-GFWOZTVB.js.map
