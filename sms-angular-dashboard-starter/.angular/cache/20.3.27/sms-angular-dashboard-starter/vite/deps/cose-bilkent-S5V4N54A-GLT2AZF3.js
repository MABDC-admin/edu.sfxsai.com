...
var render = __name((_0, _1, _2, _3) => __async(null, [_0, _1, _2, _3], function* (data4Layout, svg, {
  ...
  yield Promise.all(
    data4Layout.nodes.map((node) => __async(null, null, function* () {
      if (node.isGroup) {
  ...
  yield Promise.all(
    data4Layout.edges.map((edge) => __async(null, null, function* () {
...
//# sourceMappingURL=cose-bilkent-S5V4N54A-GLT2AZF3.js.map
