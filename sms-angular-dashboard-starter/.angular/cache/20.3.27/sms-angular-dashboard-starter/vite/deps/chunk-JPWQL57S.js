...
var calculateMathMLDimensions = __name((text, config2) => __async(null, null, function* () {
  const divElem = document.createElement("div");
  divElem.innerHTML = yield renderKatexSanitized(text, config2);
...
var renderKatexUnsanitized = __name((text, config2) => __async(null, null, function* () {
  if (!hasKatex(text)) {
    return text;
  }
  ...
  if (true) {
    const { default: katex } = yield import("./katex-7QEWVFLV.js");
...
var renderKatexSanitized = __name((text, config2) => __async(null, null, function* () {
  return sanitizeText(yield renderKatexUnsanitized(text, config2), config2);
...
//# sourceMappingURL=chunk-JPWQL57S.js.map
