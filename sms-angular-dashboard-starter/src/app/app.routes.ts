...
import { RegistrarProfileComponent } from './pages/registrar/registrar-profile/registrar-profile.component';
...
import { FinanceProfileComponent } from './pages/finance/finance-profile/finance-profile.component';
import { FinanceReportsComponent } from './pages/finance/finance-reports/finance-reports.component';
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: RegistrarProfileComponent,
        canActivate: [roleGuard],
        title: 'Registrar Profile | SFXSAI',
        data: { roles: ['REGISTRAR'], pageTitle: 'Registrar Profile', pageSubtitle: 'Manage registrar account identity and display name' }
      },
      {
      ...
      },
      {
        ...
        data: {
          roles: ['REGISTRAR', 'PRINCIPAL', 'TEACHER', 'ADMIN'],
      ...
      },
      {
        ...
        canActivate: [roleGuard],
        title: 'Finance Profile | SFXSAI',
        data: { roles: ['FINANCE'], pageTitle: 'Finance Profile', pageSubtitle: 'Manage finance account identity and display name' }
      },
      {
      ...
      },
      {
        ...
        canActivate: [roleGuard],
        title: 'Finance Reports | SFXSAI',
        data: { roles: ['FINANCE'], pageTitle: 'Finance Reports', pageSubtitle: 'Collections, receivables, ledger, discount, and clearance exports' }
      },
      {
