...
assert.deepEqual(resolveSocketEndpoint('/api', 'http://91.98.20.229:8088'), {
  url: 'http://91.98.20.229:8088',
  path: '/api/socket.io',
});

assert.deepEqual(resolveSocketEndpoint('http://localhost:3000'), {
  url: 'http://localhost:3000',
  path: '/socket.io',
});

assert.deepEqual(resolveSocketEndpoint('https://school.example.com/api'), {
