import {
  at
} from "./chunk-L7XEHNQU.js";
import {
  compileStyles,
  solidStateFill,
  styles2String,
  userNodeOverrides
} from "./chunk-WKJH6PA4.js";
import {
...
function textHelper(_0, _1, _2, _3) {
  return __async(this, arguments, function* (parent, node, config, useHtmlLabels, GAP = config.class.padding ?? 12) {
    ...
    if (node.annotations.length > 0) {
      ...
      yield addText2(annotationGroup, { text: `\xAB${annotation}\xBB` }, 0);
...
//# sourceMappingURL=chunk-MNPJRP5F.js.map
