...
function CalendarPageComponent_button_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 18);
    \u0275\u0275listener("click", function CalendarPageComponent_button_7_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function CalendarPageComponent_div_21_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275styleProp("background", type_r3.color);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(type_r3.type);
  }
}
function CalendarPageComponent_div_23_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarPageComponent_div_25_button_4_Template(rf, ctx) {
  if (rf & 1) {
...
function CalendarPageComponent_div_25_div_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 31);
    \u0275\u0275listener("click", function CalendarPageComponent_div_25_div_6_Template_div_click_0_listener($event) {
      const event_r8 = \u0275\u0275restoreView(_r7).$implicit;
      const day_r6 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      $event.stopPropagation();
      return \u0275\u0275resetView(ctx_r1.openModal(day_r6, event_r8));
    });
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275styleProp("background", event_r8.color);
    \u0275\u0275property("title", event_r8.title);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", event_r8.title, " ");
  }
}
function CalendarPageComponent_div_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 24);
    \u0275\u0275listener("click", function CalendarPageComponent_div_25_Template_div_click_0_listener() {
      const day_r6 = \u0275\u0275restoreView(_r5).$implicit;
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.openModal(day_r6));
    });
    \u0275\u0275elementStart(1, "div", 25)(2, "span", 26);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
    \u0275\u0275template(4, CalendarPageComponent_div_25_button_4_Template, 2, 0, "button", 27);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "div", 28);
    \u0275\u0275template(6, CalendarPageComponent_div_25_div_6_Template, 2, 4, "div", 29);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const day_r6 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(5, _c1, !ctx_r1.isCurrentMonth(day_r6), ctx_r1.isToday(day_r6)));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(8, _c2, ctx_r1.isToday(day_r6), !ctx_r1.isToday(day_r6)));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", day_r6.getDate(), " ");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.canEdit);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r1.getEventsForDate(day_r6));
  }
}
function CalendarPageComponent_div_26_option_34_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", type_r10.type);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(type_r10.type);
  }
}
function CalendarPageComponent_div_26_button_40_Template(rf, ctx) {
  if (rf & 1) {
    const _r11 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 53);
    \u0275\u0275listener("click", function CalendarPageComponent_div_26_button_40_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r11);
...
function CalendarPageComponent_div_26_button_43_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("disabled", ctx_r1.eventForm.invalid);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", ctx_r1.editingEventId ? "Update Event" : "Save Event", " ");
  }
}
function CalendarPageComponent_div_26_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CalendarPageComponent_div_26_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275text(7, "close");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "form", 37);
    \u0275\u0275listener("ngSubmit", function CalendarPageComponent_div_26_Template_form_ngSubmit_8_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.saveEvent());
    });
    \u0275\u0275elementStart(9, "div")(10, "label", 38);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 41)(16, "div")(17, "label", 38);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(22, "div")(23, "label", 38);
    \u0275\u0275text(24, "End Date ");
    \u0275\u0275elementStart(25, "span", 43);
    \u0275\u0275text(26, "(Optional)");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(27, "input", 44);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(34, CalendarPageComponent_div_26_option_34_Template, 2, 2, "option", 46);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(35, "div")(36, "label", 38);
    \u0275\u0275text(37, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275element(38, "textarea", 47);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "div", 48);
    \u0275\u0275template(40, CalendarPageComponent_div_26_button_40_Template, 2, 0, "button", 49);
    \u0275\u0275elementStart(41, "button", 50);
    \u0275\u0275listener("click", function CalendarPageComponent_div_26_Template_button_click_41_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.closeModal());
    });
    \u0275\u0275text(42, "Close");
    \u0275\u0275elementEnd();
    \u0275\u0275template(43, CalendarPageComponent_div_26_button_43_Template, 2, 2, "button", 51);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(!ctx_r1.canEdit ? "View Event" : ctx_r1.editingEventId ? "Edit Event" : "Add New Event");
    \u0275\u0275advance(4);
    \u0275\u0275property("formGroup", ctx_r1.eventForm);
    \u0275\u0275advance(26);
    \u0275\u0275property("ngForOf", ctx_r1.eventTypes);
    \u0275\u0275advance(6);
    \u0275\u0275property("ngIf", ctx_r1.canEdit && ctx_r1.editingEventId);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngIf", ctx_r1.canEdit);
  }
}
var CalendarPageComponent = class _CalendarPageComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CalendarPageComponent, selectors: [["app-calendar-page"]], features: [\u0275\u0275ProvidersFeature([DatePipe])], decls: 27, vars: 10, consts: [[1, "p-6", "h-full", "flex", "flex-col", "bg-slate-50/50"], [1, "flex", "items-center", "justify-between", "mb-6"], [1, "text-2xl", "font-bold", "text-slate-800"], [1, "text-sm", "text-slate-500"], ["class", "flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 transition", 3, "click", 4, "ngIf"], [1, "flex-1", "bg-white", "rounded-xl", "shadow-sm", "border", "border-slate-200", "overflow-hidden", "flex", "flex-col"], [1, "flex", "items-center", "justify-between", "p-4", "border-b", "border-slate-100"], [1, "flex", "items-center", "gap-4"], [1, "p-2", "hover:bg-slate-100", "rounded-lg", "text-slate-500", "transition", 3, "click"], [1, "material-icons"], [1, "text-lg", "font-bold", "text-slate-700", "min-w-[150px]", "text-center"], [1, "flex", "gap-4", "items-center"], ["class", "flex items-center gap-1.5", 4, "ngFor", "ngForOf"], [1, "grid", "grid-cols-7", "border-b", "border-slate-100", "bg-slate-50"], ["class", "py-2 text-center text-xs font-bold text-slate-500 uppercase tracking-wider", 4, "ngFor", "ngForOf"], [1, "flex-1", "grid", "grid-cols-7", "grid-rows-5", "bg-slate-200", "gap-px"], ["class", "bg-white min-h-[100px] p-2 transition hover:bg-slate-50 cursor-pointer flex flex-col group relative", 3, "ngClass", "click", 4, "ngFor", "ngForOf"], ["class", "fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4", 4, "ngIf"], [1, "flex", "items-center", "gap-2", "px-4", "py-2", "bg-indigo-600", "text-white", "text-sm", "font-semibold", "rounded-lg", "hover:bg-indigo-700", "transition", 3, "click"], [1, "material-icons", "text-[18px]"], [1, "flex", "items-center", "gap-1.5"], [1, "w-3", "h-3", "rounded-full"], [1, "text-xs", "font-medium", "text-slate-600"], [1, "py-2", "text-center", "text-xs", "font-bold", "text-slate-500", "uppercase", "tracking-wider"], [1, "bg-white", "min-h-[100px]", "p-2", "transition", "hover:bg-slate-50", "cursor-pointer", "flex", "flex-col", "group", "relative", 3, "click", "ngClass"], [1, "flex", "justify-between", "items-start"], [1, "text-sm", "font-semibold", "w-7", "h-7", "flex", "items-center", "justify-center", "rounded-full", 3, "ngClass"], ["class", "material-icons text-[16px] text-slate-300 opacity-0 group-hover:opacity-100 hover:text-indigo-600 transition", 4, "ngIf"], [1, "mt-2", "flex", "flex-col", "gap-1", "overflow-y-auto", "flex-1", "custom-scrollbar"], ["class", "px-2 py-1 rounded text-[10px] font-bold text-white truncate shadow-sm transition hover:brightness-110", 3, "background", "title", "click", 4, "ngFor", "ngForOf"], [1, "material-icons", "text-[16px]", "text-slate-300", "opacity-0", "group-hover:opacity-100", "hover:text-indigo-600", "transition"], [1, "px-2", "py-1", "rounded", "text-[10px]", "font-bold", "text-white", "truncate", "shadow-sm", "transition", "hover:brightness-110", 3, "click", "title"], [1, "fixed", "inset-0", "z-50", "flex", "items-center", "justify-center", "bg-slate-900/50", "backdrop-blur-sm", "p-4"], [1, "bg-white", "rounded-xl", "shadow-xl", "w-full", "max-w-md", "overflow-hidden", "animate-in", "fade-in", "zoom-in-95", "duration-200"], [1, "px-6", "py-4", "border-b", "border-slate-100", "flex", "justify-between", "items-center", "bg-slate-50"], [1, "text-lg", "font-bold", "text-slate-800"], [1, "text-slate-400", "hover:text-slate-600", "transition", "p-1", 3, "click"], [1, "p-6", "flex", "flex-col", "gap-4", 3, "ngSubmit", "formGroup"], [1, "block", "text-xs", "font-semibold", "text-slate-700", "mb-1"], [1, "text-red-500"], ["type", "text", "formControlName", "title", "placeholder", "E.g., Midterm Exams", 1, "w-full", "text-sm", "border-slate-200", "rounded-lg", "focus:ring-indigo-500", "focus:border-indigo-500", "placeholder-slate-400"], [1, "grid", "grid-cols-2", "gap-4"], ["type", "date", "formControlName", "eventDate", 1, "w-full", "text-sm", "border-slate-200", "rounded-lg", "focus:ring-indigo-500", "focus:border-indigo-500"], [1, "text-slate-400", "font-normal"], ["type", "date", "formControlName", "endDate", 1, "w-full", "text-sm", "border-slate-200", "rounded-lg", "focus:ring-indigo-500", "focus:border-indigo-500"], ["formControlName", "eventType", 1, "w-full", "text-sm", "border-slate-200", "rounded-lg", "focus:ring-indigo-500", "focus:border-indigo-500"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "description", "rows", "3", "placeholder", "Any additional details...", 1, "w-full", "text-sm", "border-slate-200", "rounded-lg", "focus:ring-indigo-500", "focus:border-indigo-500", "placeholder-slate-400"], [1, "mt-4", "flex", "justify-end", "gap-3", "pt-4", "border-t", "border-slate-100"], ["type", "button", "class", "mr-auto text-sm font-semibold text-red-600 hover:text-red-700 px-3 py-2 rounded-lg hover:bg-red-50 transition", 3, "click", 4, "ngIf"], ["type", "button", 1, "px-4", "py-2", "text-sm", "font-semibold", "text-slate-600", "hover:bg-slate-100", "rounded-lg", "transition", 3, "click"], ["type", "submit", "class", "px-4 py-2 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed", 3, "disabled", 4, "ngIf"], [3, "value"], ["type", "button", 1, "mr-auto", "text-sm", "font-semibold", "text-red-600", "hover:text-red-700", "px-3", "py-2", "rounded-lg", "hover:bg-red-50", "transition", 3, "click"], ["type", "submit", 1, "px-4", "py-2", "text-sm", "font-semibold", "text-white", "bg-indigo-600", "hover:bg-indigo-700", "rounded-lg", "transition", "disabled:opacity-50", "disabled:cursor-not-allowed", 3, "disabled"]], template: function CalendarPageComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275template(7, CalendarPageComponent_button_7_Template, 4, 0, "button", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "div", 5)(9, "div", 6)(10, "div", 7)(11, "button", 8);
      \u0275\u0275listener("click", function CalendarPageComponent_Template_button_click_11_listener() {
      ...
      \u0275\u0275listener("click", function CalendarPageComponent_Template_button_click_17_listener() {
      ...
      \u0275\u0275template(21, CalendarPageComponent_div_21_Template, 4, 3, "div", 12);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "div", 13);
      \u0275\u0275template(23, CalendarPageComponent_div_23_Template, 2, 1, "div", 14);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "div", 15);
      \u0275\u0275template(25, CalendarPageComponent_div_25_Template, 7, 11, "div", 16);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(26, CalendarPageComponent_div_26_Template, 44, 5, "div", 17);
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      \u0275\u0275property("ngIf", ctx.canEdit);
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(16, 6, ctx.currentDate, "MMMM yyyy"), " ");
      \u0275\u0275advance(6);
...
(() => {
  ...
  <div class="flex items-center justify-between mb-6">\r
    ...
    <button *ngIf="canEdit" (click)="openModal()" class="flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 transition">\r
    ...
    <div class="flex-1 grid grid-cols-7 grid-rows-5 bg-slate-200 gap-px">\r
      <div *ngFor="let day of daysInMonth" \r
        ...
        <div class="flex justify-between items-start">\r
          ...
          <button *ngIf="canEdit" class="material-icons text-[16px] text-slate-300 opacity-0 group-hover:opacity-100 hover:text-indigo-600 transition">add</button>\r
        </div>\r
\r
...
<div *ngIf="showModal" class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">\r
  <div class="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">\r
    <div class="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50">\r
      <h3 class="text-lg font-bold text-slate-800">{{ !canEdit ? 'View Event' : (editingEventId ? 'Edit Event' : 'Add New Event') }}</h3>\r
...
\r
      <div class="mt-4 flex justify-end gap-3 pt-4 border-t border-slate-100">\r
        <button *ngIf="canEdit && editingEventId" type="button" (click)="deleteEvent()" class="mr-auto text-sm font-semibold text-red-600 hover:text-red-700 px-3 py-2 rounded-lg hover:bg-red-50 transition">\r
          Delete\r
        </button>\r
        <button type="button" (click)="closeModal()" class="px-4 py-2 text-sm font-semibold text-slate-600 hover:bg-slate-100 rounded-lg transition">Close</button>\r
        <button *ngIf="canEdit" type="submit" [disabled]="eventForm.invalid" class="px-4 py-2 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 rounded-lg transition disabled:opacity-50 disabled:cursor-not-allowed">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CalendarPageComponent, { className: "CalendarPageComponent", filePath: "src/app/pages/calendar/calendar.component.ts", lineNumber: 16 });
})();
export {
  CalendarPageComponent
};
//# sourceMappingURL=chunk-EZFELV7J.js.map
